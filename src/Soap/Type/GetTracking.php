...
/**
 * This class stands for getTracking Type
 *
 * @date 2018/04/06
 * @codeVersion 0.0.1
 */
class GetTracking extends AbstractStructBase
{
    /**
     * The awbNo
    ...
    /**
     * Constructor method for getTracking
     *
     * @uses GetTracking::setAwbNo()
     * @uses GetTracking::setPasskey()
     *
     * @param string $awbNo
     ...
     * @param string $awbNo
     *
     * @return \Alhoqbani\SMSAWebService\Soap\Type\GetTracking
     */
