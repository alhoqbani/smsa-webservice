...
/**
 * This class stands for getTrackingwithRef Type
 *
 * @date 2018/04/06
 * @codeVersion 0.0.1
 */
class GetTrackingwithRef extends AbstractStructBase
{
    /**
     * The awbNo
    ...
    /**
     * Constructor method for getTrackingwithRef
     *
     * @uses GetTrackingwithRef::setAwbNo()
     * @uses GetTrackingwithRef::setPasskey()
     *
     * @param string $awbNo
