 ...
 * @codeVersion 0.0.1
 */
class AddShipMPS extends AbstractStructBase
{
    /**
     * The PCs
     ...
     * @uses AddShipMPS::setSentDate()
     * @uses AddShipMPS::setIdNo()
     * @uses AddShipMPS::setCName()
     * @uses AddShipMPS::setCntry()
     * @uses AddShipMPS::setCCity()
     * @uses AddShipMPS::setCZip()
     * @uses AddShipMPS::setCPOBox()
     * @uses AddShipMPS::setCMobile()
     * @uses AddShipMPS::setCTel1()
     * @uses AddShipMPS::setCTel2()
     * @uses AddShipMPS::setCAddr1()
     * @uses AddShipMPS::setCAddr2()
     * @uses AddShipMPS::setShipType()
     * @uses AddShipMPS::setCEmail()
     * @uses AddShipMPS::setCarrValue()
     * @uses AddShipMPS::setCarrCurr()
     * @uses AddShipMPS::setCodAmt()
     * @uses AddShipMPS::setWeight()
     * @uses AddShipMPS::setCustVal()
     * @uses AddShipMPS::setCustCurr()
     * @uses AddShipMPS::setInsrAmt()
     * @uses AddShipMPS::setInsrCurr()
     * @uses AddShipMPS::setItemDesc()
     * @uses AddShipMPS::setSName()
     * @uses AddShipMPS::setSContact()
     * @uses AddShipMPS::setSAddr1()
     * @uses AddShipMPS::setSAddr2()
     * @uses AddShipMPS::setSCity()
     * @uses AddShipMPS::setSPhone()
